...
JAR_NAME = "SettlerAffix-1.3.3-1.0.jar"
MOD_INFO = """{
\tid = origami.settleraffix,
\tname = Settler Affix,
\tversion = 1.0,
\tgameVersion = 1.3.3,
\tauthor = Origami,
\tdescription = Commands panel buttons to stop/start storage collecting for all Gem/Flower/Hired Hand settlers.,
\tclientside = false
}
"""
